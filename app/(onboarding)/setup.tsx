...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 20, fontWeight: '700', color: '#6C63FF', marginBottom: 24 },
  title: { fontSize: 30, fontWeight: '700', color: '#1A1A2E', marginBottom: 8 },
  subtitle: { fontSize: 15, color: '#666', lineHeight: 22 },
  form: { flex: 1 },
  colorLabel: { fontSize: 14, fontWeight: '600', color: '#333', marginBottom: 12, marginTop: 8 },
  fieldError: { fontSize: 12, color: '#FF6B6B', marginTop: 6, textAlign: 'center' },
  submitError: {
    fontSize: 14,
    color: '#FF6B6B',
    textAlign: 'center',
